...
export const docsNavigation: DocsNavItem[] = [
  ...
  },
  {
    ...
    summary: "Interface, lentes, modos e controles manuais.",
    group: "Fotografar",
    keywords: ["iso", "obturador", "raw", "live photo", "retrato", "sorriso"],
  },
  {
    slug: "cores-e-efeitos",
    title: "Cores e efeitos",
    summary: "LUTs, arquivos .cube, grão, halation e cópia original.",
  ...
  },
  {
    ...
    group: "Referência",
    keywords: ["topbar", "histograma", "nível", "som", "localização"],
  },
  {
